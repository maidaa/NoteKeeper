...
public class NoteActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public static final String NOTE_ID = "com.example.maida.notekeeper.NOTE_ID";
    public static final String ORIGINAL_NOTE_COURSE_ID = "com.example.maida.notekeeper.ORIGINAL_NOTE_COURSE_ID";
    public static final String ORIGINAL_NOTE_TITLE = "com.example.maida.notekeeper.ORIGINAL_NOTE_TITLE";
    public static final String ORIGINAL_NOTE_TEXT = "com.example.maida.notekeeper.ORIGINAL_NOTE_TEXT";
    ...
    protected void onPause() {
        super.onPause();
        if(mIsCancelling){
            Log.i(TAG, "Cancelling note at positon " + mNoteId);
            if(mIsNewNote) {
    ...
    private void sendEmail() {
        ...
        String text = "Checkout what I've leared on PluralSight course \"" + course.getTitle() + "\"\n" + mTextNoteText.getText().toString();
