        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.text_note_title),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("aaaaa"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.text_note_text),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("bbbb"), closeSoftKeyboard());

        pressBack();

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.text_note_text), withText("bbbb"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.CoordinatorLayout")),
                                        1),
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("bbbbbbb"));

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.text_note_text), withText("bbbbbbb"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.CoordinatorLayout")),
                                        1),
